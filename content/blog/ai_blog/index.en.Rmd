---
title: "WOW, I Look Like a Bobblehead: The Ethical Considerations of AI Photo Generation"
author: "Sarah"
date: "2023-09-18"
...
AI software is undoubtedly a global hot topic right now. In late 2022, [Pew Research](https://www.pewresearch.org/science/2023/02/15/public-awareness-of-artificial-intelligence-in-everyday-activities/) surveyed Americans to understand their awareness and use of AI software and reported that the majority of survey respondents (~55%) said they often interact with AI tools. In the same survey, approximately 38% of respondents reported being more “concerned than excited” regarding the proliferation of AI technology in daily life. Beyond mundane consumers, there are concerns amongst [experts](https://www.pewresearch.org/internet/2021/06/16/1-worries-about-developments-in-ai/) regarding the ethical design of AI tools and technologies. 
...
```{r, echo=FALSE, out.width = '80%', fig.align="center", wrapfigure = list("R", .7)}
knitr::include_graphics("actual.png")

```

Me being me, I shared the results with a few close friends, and I am HERE for it.

```{r, echo=FALSE, fig.cap="Friend's Reactions", out.width = '80%', fig.align="center", wrapfigure = list("R", .7)}
