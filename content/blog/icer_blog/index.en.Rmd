---
title: 'My first in-person conference experience: ICER 2022'
...
```
Upon entering my fourth and final year of my PhD studies, I finally attended and presented at my first in-person conference at the International Computing Education Research ([ICER](https://icer2022.acm.org/)) conference in Lugano, Switzerland. During my PhD studies, I have presented at three virtual conferences but have never presented or attended an in-person conference due to COVID. 

Me and my mentor, [Lexi](https://twitter.com/lishinskialex) Lishinski, presented our (with [Joshua](https://twitter.com/jrosenberg6432) Rosenberg) paper which was accepted and published in the ICER conference proceedings: [Self-efficacy, Interest, and Belongingness – URM Students’ Momentary Experiences in CS](https://dl.acm.org/doi/pdf/10.1145/3501385.3543958). Normally I consider myself a good presenter, but during our presentation I realized that I have never presented in front of a large in-person audience. Our presentation went very well and I am fortunate to have that experience before graduating. 
...
```{r pressure, echo=FALSE, fig.cap="Lexi and I Post Presentation!", out.width = '70%', fig.align="center", wrapfigure = list("R", .7)}
knitr::include_graphics("icer.JPG")
